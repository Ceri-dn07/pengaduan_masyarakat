...
<h3 class="mb-4">Dashboard</h3>
    <div class="row mb-3">
        ...
        <div class="col-md-4">
            <div class="card p-4 shadow-sm">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ App\Models\Masyarakat::all()->count() }}</h5>
        ...
        <div class="col-md-4">
            <div class="card p-4 shadow-sm">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ App\Models\Petugas::all()->count() }}</h5>
                    <i class="fas fa-user-shield text-danger fs-3"></i>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <!-- Statistik Pengaduan dalam Beberapa Hari -->
            <div class="card mb-4">
    ...
    <!-- Statistik dalam bentuk Diagram -->
    <div class="row mt-4">
        <div class="col-md-6">
            <div class="card p-4">
    ...
    <script>
        ...
        const userChart = new Chart(userCtx, {
            type: 'bar',
            data: {
                labels: ['Masyarakat', 'Petugas'],
                datasets: [{
                    label: 'Jumlah',
                    data: [{{ $jumlahMasyarakat }}, {{ $jumlahPetugas }}],
